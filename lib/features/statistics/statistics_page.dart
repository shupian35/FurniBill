...
class _StatisticsPageState extends State<StatisticsPage> with SingleTickerProviderStateMixin {
  ...
  Widget _buildChart(List<Map<String, dynamic>> data, String unit) {
    ...
    final maxY = data.map((d) => (d['amount'] as num).toDouble()).reduce((a, b) => a > b ? a : b) * 1.3;
    return Padding(
      ...
      child: Column(children: [
              ...
              titlesData: FlTitlesData(
                bottomTitles: AxisTitles(sideTitles: SideTitles(
                  ...
                  getTitlesWidget: (v, _) {
                    ...
                    return Text(data[idx]['period'].toString(), style: const TextStyle(fontSize: 10));
                  },
                )),
        ...
        Text('销售额合计: ¥${data.fold<double>(0, (s, d) => s + (d['amount'] as num).toDouble()).toStringAsFixed(2)}',
