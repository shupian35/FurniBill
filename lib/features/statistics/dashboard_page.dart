              ...
              children: [
                Expanded(
                  child: _StatCard(
                    label: '开单数',
                    value:
                        _todayStats['order_count']?.toInt().toString() ?? '0',
                ...
                Expanded(
                  child: _StatCard(
                    label: '销售额',
                    value:
                        '¥${(_todayStats['total_sales'] ?? 0).toStringAsFixed(0)}',
              ...
              children: [
                Expanded(
                  child: _StatCard(
                    label: '回款',
                    value:
                        '¥${(_todayStats['total_received'] ?? 0).toStringAsFixed(0)}',
                    icon: Icons.payments,
                    color: Colors.orange,
                  ),
                ),
                ...
                Expanded(
                  child: _StatCard(
                    label: '新增欠款',
                    value:
                        '¥${(_todayStats['total_owing'] ?? 0).toStringAsFixed(0)}',
              ...
              child: InkWell(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const InventoryAlertPage(),
                    ),
                  );
                },
                child: Padding(
              ...
              SizedBox(
                ...
                child: BarChart(
                  BarChartData(
                    ...
                    maxY:
                        _weeklySales
                            .map((s) => (s['amount'] as num).toDouble())
                            .reduce((a, b) => a > b ? a : b) *
                        1.3,
                      ...
                      bottomTitles: AxisTitles(
                        sideTitles: SideTitles(
                          ...
                          getTitlesWidget: (value, meta) {
                            ...
                            final period =
                                _weeklySales[idx]['period'] as String;
                            return Text(
                              period.length >= 5 ? period.substring(5) : period,
